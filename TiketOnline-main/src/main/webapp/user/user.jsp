                        ...
                        <c:forEach var="user" items="${user}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/deleteUser?idUser=${user.getIdUser()}" onclick="return confirm('Yakin mau hapus?');" button type="button" class="btn btn-outline-danger"> hapus </a>
                                    <a href="/showAllUserTiket?idUser=${user.getIdUser()}" button type="button" class="btn btn-outline-info"> tiket </a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
