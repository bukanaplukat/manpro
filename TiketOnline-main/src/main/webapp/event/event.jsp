                        ...
                        <c:forEach var="e" items="${event}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/showUpdateEventForm?id=${e.idEvent}" button type="button" class="btn btn-outline-primary" > edit  </a>
                                    <a href="/showAllEventTikets?idEvent=${e.idEvent}" button type="button" class="btn btn-outline-info"> tiket </a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
